...
constexpr inline TYPE inline_int_null_value();
template <typename TYPE>
constexpr inline TYPE inline_fp_null_value();
template <typename TYPE>
constexpr inline TYPE null_builder();
template <typename TYPE>
...
template <typename TYPE>
constexpr inline TYPE avxbmp::helpers::inline_int_null_value() {
  return std::is_signed<TYPE>::value ? std::numeric_limits<TYPE>::min()
